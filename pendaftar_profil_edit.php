...
$data = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM pendaftar WHERE id_pendaftar = $id_pendaftar"));
$data2 = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM ortu WHERE id_pendaftar = $id_pendaftar"));
...
<form method="post" action="" enctype="multipart/form-data">
  ...
  <div class="form-group mb-3">
    ...
    <input type="number" name="nisn" class="form-control" placeholder="Masukan nisn" value="<?= $data['nisn'] ?>">
  </div>
  <div class="row mb-3">
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select name="agama" class="form-control">
          <option value="Islam" <?php ($data['agama'] == 'Islam') ? 'selected' : '' ?> >Islam</option>
          <option value="Kristen" <?php ($data['agama'] == 'Kristen') ? 'selected' : '' ?> >Kristen</option>
          <option value="Hindu" <?php ($data['agama'] == 'Hindu') ? 'selected' : '' ?> >Hindu</option>
          <option value="Budha" <?php ($data['agama'] == 'Budha') ? 'selected' : '' ?> >Budha</option>
          <option value="Konghucu" <?php ($data['agama'] == 'Konghucu') ? 'selected' : '' ?> >Konghucu</option>
        </select>
      </div>
    </div>
  </div>
  <div class="form-group mb-3">
    ...
    <textarea name="alamat" class="form-control mb-3" cols="2" rows="2" placeholder="Masukan alamat"><?= $data['alamat'] ?></textarea>
  </div>
  <div class="row">
    <div class="col-md-6">
      <div class="form-group mb-3">
  ...
  <div class="form-group mb-3">
    ...
    <select name="jns_kelamin" class="form-control">
      <option value="Laki-laki" <?php ($data['jns_kelamin'] == 'Laki-laki') ? 'selected' : '' ?> >Laki-laki</option>
      <option value="Perempuan" <?php ($data['jns_kelamin'] == 'Perempuan') ? 'selected' : '' ?> >Perempuan</option>
    </select>
  </div>
  <div class="form-group mb-3">
  ...
  <div class="form-group mb-3">
    ...
    <input type="text" name="nama_ayah" class="form-control" placeholder="Masukan nama ayah" value="<?= $data2['nama_ayah'] ?>">
  </div>
  <div class="form-group mb-3">
    <label class="mb-1">Nama ibu</label>
    <input type="text" name="nama_ibu" class="form-control" placeholder="Masukan nama ibu" value="<?= $data2['nama_ibu'] ?>">
  </div>
  <div class="form-group mb-3">
    <label class="mb-1">Pekerjaan ayah</label>
    <input type="text" name="pekerjaan_ayah" class="form-control" placeholder="Masukan pekerjaan ayah" value="<?= $data2['pekerjaan_ayah'] ?>">
  </div>
  <div class="form-group mb-3">
    <label class="mb-1">Pendidikan ayah</label>
    <input type="text" name="pendidikan_ayah" class="form-control" placeholder="Masukan pendidikan ayah" value="<?= $data2['pendidikan_ayah'] ?>">
  </div>
  <div class="form-group mb-3">
    <label class="mb-1">No HP</label>
    <input type="text" name="telp" class="form-control" placeholder="Masukan no hp" value="<?= $data2['telp'] ?>">
  </div>
